      ...
      <section className="bg-cream py-section">
        <div className="shell">
          {posts.length > 0 ? (
            <ul>
              {posts.map((post) => (
                <li key={post.slug} className="border-t-2 border-ink/15 py-10 last:border-b">
                  <article className="grid-12 gap-y-3">
                    <time className="col-span-4 text-eyebrow font-semibold uppercase text-ink/45 md:col-span-2">
                      {post.date}
                    </time>
                    <h2 className="col-span-4 font-extrabold text-[clamp(1.6rem,3vw,2.4rem)] leading-tight text-ink md:col-span-6 md:col-start-3">
                      {post.title}
                    </h2>
            ...
            <div className="grid-12 gap-y-10">
              <Reveal className="col-span-4 md:col-span-6 md:col-start-3">
                <div className="border border-dashed border-ink/25 p-10 md:p-16">
                  ...
                  <p className="mt-8 max-w-[26ch] font-extrabold text-[clamp(1.5rem,3vw,2.25rem)] leading-tight text-ink/35">
